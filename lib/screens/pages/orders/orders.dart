...
import 'package:dstmobileapp/screens/pages/orders/order_details.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Obx(() {
                return Text(
                  "MY SALES : ${orderController.mySalesCount}",
              ...
              SearchBox(onchanged: (val) {
                orderController.filterOrders(val);
              }),
                ...
                child: Obx(
                  () {
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        children: orderController.filteredOrders
